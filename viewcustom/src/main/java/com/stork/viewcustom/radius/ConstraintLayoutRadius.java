...
public class ConstraintLayoutRadius extends ConstraintLayout {
    ...
    public ConstraintLayoutRadius(Context context) {
        super(context);
        init(context, null);
    }

    public ConstraintLayoutRadius(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public ConstraintLayoutRadius(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    public ConstraintLayoutRadius(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
