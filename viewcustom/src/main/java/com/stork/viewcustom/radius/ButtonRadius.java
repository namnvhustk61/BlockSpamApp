...
class ButtonRadius  extends androidx.appcompat.widget.AppCompatButton {
    ...
    public ButtonRadius(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public ButtonRadius(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
